  ...
  return (
    <div className="header">
      ...
      <div className="header_right">
        ...
        <Avatar src={user?.photoURL} onClick={logOut} ></Avatar>
      </div>
    </div>
  );
};
